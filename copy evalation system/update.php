...
<?php
  ...
  <div class="header">
    <div class="block_header">
      <div class="logo"><font size="+4" color="#FFFFFF" ><marquee behavior="scroll" direction="left"> 
  ...
  <div class="clr"></div>
      ...
      <!-- START CONTAINER ABOUT -->
		<div class="right">
          ...
          <form id="f13" name="f13" method="post" action="update_action.php">
<div class="main">
                   <center> 
                   ...
                   <center>
                       ...
                       <td width="192">
                       <input type="text" class="incoo"  name="nam1" value="<?php
				   echo $rs['sch_name']
				   ?>"/>
                       </td>
                       </tr>
                       ...
                       <td>
                       <input type="text" class="incoo" name="reg1"   value=" <?php
				   echo $rs['reg_no'];
				   ?> "/>
                       </td>
                       </tr>
                       ...
                       <td>
                       <input type="text" class="incoo" name="con1" value="<?php
				   echo $rs['con_no'] ?>"/>
                       </td>
                       </tr>
                       ...
                       <td>
                       <input type="text" class="incoo"   name="em1" value="<?php
				   echo $rs['e_mail']
				   ?>"/>
                       </td>
                       </tr>
                         ...
                         <font color="#CCFF00"><strong> Address </strong></font>
                          ...
                          <td width="192">
                            <input type="text" class="incoo" name="str1"   value="<?php
				   echo $rs['str_1']
				   ?>"/>
                          </td>
                          </tr>
                          ...
                          <td>
                            <input type="text" class="incoo" name="str2" value="<?php
				   echo $rs['str_2']
				   ?>"/>
                           </td>
                           </tr>
                           ...
                           <td>
                             <input type="text" class="incoo" name="cit1"    value="<?php
				   echo $rs['city']
				   ?>"/>
                          </td>
                          </tr>
                           ...
                           <td><input type="text" class="incoo"   name="dis1" value="<?php
				   echo $rs['dist']
				   ?>"/>
                           </td>
                           </tr>
                           ...
                           <td height="36"><font color="#FFFF99">
                            ...
                            <td>
                              <input type="text" class="incoo" name="sta1"  value="<?php
				   echo $rs['state']
				   ?>"/>
                            </td>
                            </tr>
                           ...
                           <td height="25"><font color="#FFFF99">
                            ...
                            <td>
                              <input type="text" class="incoo"  name="pin" value="<?php
				   echo $rs['pin']
				   ?>"/>
                            </td>
                            </tr>
                        ...
                        <hr size="3" color="#666666"><table width="474" height="35" align="center"><tr>
<td width="214">
                          <font color="#00CCFF">
                       ...
                       <td width="206">
                      <input type="text" class="incoo"  name="pass" value="<?php
				   echo $rs['pas']
				   ?>"/>
      </td></tr></table>
                       <hr size="3" color="#666666">
                    ...
                    <td width="59">
                    <input type="button" value="Proced for login" onClick="call();">
                    </td>
                    </tr>
                    </table>
                    </center>
                    <input type="hidden" class="incoo"  name="reg_code" value="<?php
				   echo $rs['reg_code']
				   ?>"/>
        </form>               
     ...
     <div class="lef1">
        ...
        <center> <font color="#993300" size="+2">Evaluator Registration</font></center> </div>
      </div>
      <div class="clr"></div>
    </div>
  </div>

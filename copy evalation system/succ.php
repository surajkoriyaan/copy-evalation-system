...
function googleTranslateElementInit() {
  ...
  <div class="clr"></div>
      ...
      <!-- START CONTAINER ABOUT -->
		<div class="right1">
        <hr size="4" color="#00FFFF" width="700px">
        <center>
         <font  size="+3" color="#FF6600" face="Georgia, Times New Roman, Times, serif"  > <b> 
        <img src="images/Info.png" width="184"><br>
        Student information is Successfully Uploaded</b></font>
        <br>
        <br>
         <input type="button" value="Go to Options Page" onClick="info()";>&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

...
<body bgcolor="#990000">
<form name ="fm4" Method="post" Action="mks.php" id="fm2">
 ...
 <input type="text" class="inco" name="wc1" id="wc1" readonly value="<?php echo $rs['reg'] ?>">
     ...
     <table width="224" height="110">
    	...
    	<hr size="5" color="#3399FF">
   		...
   		<font size="+4"  color="#CCFF66">
	<table width="226" height="35">
   		  <tr>
   		    <td width="19" height="29">1.</td>
   		    <td width="24"><font face="Georgia, Times New Roman, Times, serif">i )</font></td>
   		    <td width="56"><input type="text" class="coput1" name="A1" id="A1" onBlur='Calculate();'></td>
   		    <td width="52"><font face="Georgia, Times New Roman, Times, serif">ii )</font></td>
   		    <td width="51"><input type="text" class="coput1" name="A2" id="A2" onBlur='Calculate();'></td>
	      </tr>
    </table>
        <center>
        </center>
...
echo '</div>';
		...
		?>	
        <div id="container">
      <canvas id="imageView" width="1050" height="900">

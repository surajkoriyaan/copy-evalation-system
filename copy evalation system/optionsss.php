...
<script type="text/javascript">
	function inf()
	{
	window.location.assign("paper_info.php");
}

function dt()
	{
	window.location.assign("delete_upload.php");
}
  ...
  <div class="clr"></div>
      ...
      <!-- START CONTAINER ABOUT -->
		<div class="right1"><center>
         <font  size="+3" color="#FF6600" face="Georgia, Times New Roman, Times, serif"  > <b> Choose form the following options</b></font>
         ...
         <div class="lef22">
         <center>
         <input type="button"  class="button" value="Add  &nbsp; Student &nbsp; Information " onClick="inf()";>
         </center>
         ...
         <input type="button"  class="button" value="Delete &nbsp; Student &nbsp; Information" onClick="dt()";> 
         ...
         <input type="button"  class="button" value="Go to school input form" onClick="log()";> 
         ...
         <table width="580" height="315">
                    <tr>
                    <td width="229" height="90">&nbsp;</td>
                    <td width="339">
                    <input type="button"  class="button" value="Insert &nbsp; Student &nbsp; Information " onClick="info()";>
                    </td>
           </tr>
                    ...
                    <td height="99">&nbsp;</td>
                    <td>
                   <input type="button"  class="button" value="Delete &nbsp; Student &nbsp; Information" onClick="del()";> 
                    </td>
                    </tr>
                   ...
                   <td>  </td>
                   <td>
                    <input type="button"  class="button" value="Logout" onClick="log()" ><br>
                    </td>
           </tr></table>-->
      ...
      <div class="clr"></div>
   <a href="school_login.php">  <div class="lef">
           <center>
            <img src="images/school.jpg" width="202" height="100">
        ...
        <a href="scn_login.php"> <div class="lef2" align="center">
        <center><img src="images/eva.jpg" width="220" height="100"></center>

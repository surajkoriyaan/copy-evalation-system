<html>
<head>Evaluator Registration</title>
...
<script type="text/javascript">
	function bak()
	{
	window.location.assign("school_input.php");
}
</script>
        ...
        <br>    
                 ...
                 <br>  
                  <br>
                   ...
                   <b>Please Fill the Information correctly
                   </b>
                   </font>
                   </center>
                   <br>
     		       <hr size="3" color="#FF6600" width="500">
                     ...
                     <br>
                      <center>
                     <form name="evaluator" id="evaluator" action="eva_regis_action.php" method="post">	
                   <table width="442" height="190">       		       
                    
                    <tr>
           			 	<td width="0" height="60"></td>
   			 	       	<td width="211">&nbsp;&nbsp;<b><font color="#FFFF00" size="+1"> Name</font></b></td>
                     	<td width="215"><input type="text" class="incoo" name="s1"
                     					 id="s1" title="Please Enter your Name">
            			</td>
                     ...
                     <tr>
           			   	<td height="60"></td>
   			   	       <td width="211">&nbsp;&nbsp;<b> <font color="#FFFF00" size="+1">Contact  &nbsp;&nbsp; Number</font></b></td>
                        <td width="215"><input type="text" class="incoo" name="s2" 
                        				 id="s2" title="Please Enter contact Number">
                		</td>
                     ...
                     <tr>
           			   	<td height="60"></td>
   			   	       <td width="211">&nbsp;&nbsp;<b><font color="#FFFF00" size="+1"> E-mail  &nbsp;&nbsp; ID</font></b></td>
                        <td width="215"><input type="text" class="incoo" name="s3" 
                        				 id="s3" title="Please Enter E-mail ID">
                		</td>
                       
                    </tr>
                    <tr>
           			   	<td height="60"></td>
   			   	       <td width="211">&nbsp;&nbsp;<b> <font color="#FFFF00" size="+1">Subject  &nbsp;&nbsp;</font></b></td>
                        <td width="215"><select class="incoo" name="s4" 
                        				 id="s4" title="Please select proper paper name for evaluation">
                     ...
                     <tr>
           			   	<td height="60"></td>
   			   	       <td width="211">&nbsp;&nbsp;<b><font color="#FFFF00" size="+1"> Password &nbsp;&nbsp;</font></b></td>
                        <td width="215"><input type="password" class="incoo" name="s5" 
                        				 id="s5" title="Please enter your password, use for login">
                		</td>

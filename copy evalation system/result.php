  ...
  <div class="clr"></div>
      ...
      <!-- START CONTAINER ABOUT -->
		<div class="right1"><center>
         ...
         <font  size="+3" color="#FF6600" face="Georgia, Times New Roman, Times, serif"  > <b>  &nbsp;&nbsp; !!! Result !!!</b></font>
         <hr size="4" color="#00FFFF" width="600px">
         </center>
         <br>
         
         <font size="+2" color="#FFFFFF">
         <form name="result" id="result" method="post" action="result_act.php">
         Enter your school code no
           <input type="text" name="r1" id="r1">
         <br>
         <br>
          Enter  your roll no:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="r2" id="r2">
        <br>
        <br>
    <center>    
 <input type="submit" name="s1" id="s2">
	</center></form>
<div class="clr"></div>
<div class="footer">
  <div class="clr"></div>

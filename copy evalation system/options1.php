...
function dt()
	{
	window.location.assign("delete_stu.php");
}
...
<script type="text/javascript">
	function info()
	{
	window.location.assign("student_info.php");
}

function del()
	{
	window.location.assign("delete_stu_info.php");
}
function log()
	{
  ...
  <div class="clr"></div>
      ...
      <!-- START CONTAINER ABOUT -->
		<div class="right1"><center>
         ...
         <table width="580" height="307">
                    <tr>
                    <td width="191" height="90">&nbsp;</td>
                    <td width="377">
                ...
                <td>
                <input type="button"  class="button" value="Goto &nbsp; School&nbsp; Input &nbsp;form &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" onClick="goto()";></td>
           </tr>    
    ...
    <div class="lef">
        ...
        <center> <font color="#993300" size="+2">Evaluator Login</font></center> </div>
      </div>
      <div class="clr"></div>
    </div>
  </div>
